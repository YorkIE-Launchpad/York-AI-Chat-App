!macro customCheckAppRunning
  ...
  nsExec::Exec 'taskkill /T /F /IM "York GrowthOS.exe"'
  Pop $R0
  ; Also stop previous product names during upgrade
  nsExec::Exec 'taskkill /T /F /IM "York WorkOS.exe"'
  Pop $R0
  ...
  nsExec::Exec 'powershell.exe -NoProfile -Command "Get-CimInstance Win32_Process | Where-Object { $$_.Name -eq ''node.exe'' -and ($$_.ExecutablePath -like ''*York GrowthOS*'' -or $$_.ExecutablePath -like ''*York WorkOS*'' -or $$_.ExecutablePath -like ''*York IE VECOS*'' -or $$_.ExecutablePath -like ''*York IE*'' -or $$_.ExecutablePath -like ''*Open Cowork*'') } | ForEach-Object { Stop-Process -Id $$_.ProcessId -Force -ErrorAction SilentlyContinue }"'
  Pop $R0
