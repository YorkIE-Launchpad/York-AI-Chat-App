  ...
  return {
    ...
    create: (input) => {
      ...
      const task: ScheduledTask = {
        ...
        hubProjectId: input.hubProjectId ?? null,
        hubProjectName: input.hubProjectName ?? null,
        launchpadProjectId: input.launchpadProjectId ?? null,
        launchpadProjectName: input.launchpadProjectName ?? null,
...
describe('ScheduledTaskManager', () => {
  ...
  it('normalizes provided title with schedule prefix', () => {
    ...
    expect(created.title).toBe(buildScheduledTaskTitle('Need paper summary'));
  });
  ...
  it('keeps existing title when prompt changes without explicit title update', () => {
    ...
    const updated = manager.update('title-update', {
      prompt: 'Weekly sales summary and send to the group',
    });
