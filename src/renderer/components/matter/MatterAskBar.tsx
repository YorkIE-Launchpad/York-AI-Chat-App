...
export function MatterAskBar({ disabled, onAsk }: MatterAskBarProps) {
  ...
  return (
    <div className="border-t border-border-muted bg-surface/40 px-4 py-3">
      <div className="mx-auto max-w-3xl flex items-center gap-2 rounded-2xl border border-border-muted bg-background px-3 py-2">
        ...
        <input
          ...
          placeholder="Ask Matter — what’s blocking me, who needs a reply, prep my next meeting…"
          disabled={disabled}
