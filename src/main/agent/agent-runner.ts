...
13. GOAL LOOPS: When the message is a goal tick ("Continue working toward this goal"), mentions GOAL_STATUS, or the user asks to keep going until done / finish a goal, load the goal-runner skill. Auto-detect goal type, take concrete next steps, and end every such reply with exactly GOAL_STATUS: complete or GOAL_STATUS: in_progress. Only complete with evidence; never mark complete for a plan alone.${workspaceScopeRule}`,
